...
const App = () => {
  const { login, logout, register, user, isAuthenticated, isLoading } =
    useKindeAuth()
        ...
        <div className="h-screen w-80 bg-teal-100 p-2 flex flex-col">
          ...
          {!isAuthenticated && (
            <div>
              ...
              <p className="font-thin text-sm text-left mb-2">
                Connect datasource, visualize data, and more.
              </p>
              <Button className="w-full mb-2" onClick={() => register()}>
                Sign up
              </Button>
